      ...
      children: [
        ExpansionPanelRadio(
          ...
          headerBuilder: (context, isExpanded) {
            return ListTile(
              title: const Text(
                "1) Équation de désintégration β⁺ du fluor-18",
                style: TextStyle(
        ...
        ExpansionPanelRadio(
          ...
          headerBuilder: (context, isExpanded) {
            return ListTile(
              title: const Text(
                "2) Nombre de noyaux restants après 3 heures",
                style: TextStyle(
                  fontSize: ExoConstants.fontSize,
                  fontWeight: FontWeight.bold,
                  color: Colors.blue,
        ...
        ExpansionPanelRadio(
          ...
          headerBuilder: (context, isExpanded) {
            return ListTile(
              title: const Text(
                "3) Calcul de l'activité et vérification",
                style: TextStyle(
                  fontSize: ExoConstants.fontSize,
                  fontWeight: FontWeight.bold,
                  color: Colors.blue,
        ...
        ExpansionPanelRadio(
          ...
          headerBuilder: (context, isExpanded) {
            return ListTile(
              title: const Text(
                "4) Temps pour que 3/4 des noyaux disparaissent",
                style: TextStyle(
                  fontSize: ExoConstants.fontSize,
                  fontWeight: FontWeight.bold,
                  color: Colors.blue,
