  ...
  Widget build(BuildContext context) {
    return DetailsHandler(
      details: Column(
        ...
        children: [
          // Raisonnement détaillé : Désintégration α de l'uranium-238 avec les lois de conservation

          // Étape 1 : Équation de départ avec noyau fils inconnu
          tex(
            math:
                r"\begin{array}{l} _{92}^{238}U \longrightarrow _{Z}^{A}X + _2^4He \end{array}",
            scale: 2.0,
          ),
          EspConstants.esp40,
          ...
          tex(math: r"\begin{array}{l} 238 = A + 4 \end{array}"),
          EspConstants.esp40,

          // Étape 4 : Résolution pour A
          tex(math: r"\begin{array}{l} \Rightarrow \ A = 238 - 4 \end{array}"),
          EspConstants.esp40,

          // Étape 5 : Résultat pour A
          tex(math: r"\begin{array}{l} \Rightarrow \ A = 234 \end{array}"),
          EspConstants.esp40,
          ...
          tex(math: r"\begin{array}{l} 92 = Z + 2 \end{array}"),
          EspConstants.esp40,

          // Étape 8 : Résolution pour Z
          tex(math: r"\begin{array}{l} \Rightarrow \ Z = 92 - 2 \end{array}"),
          EspConstants.esp40,

          // Étape 9 : Résultat pour Z
          tex(math: r"\begin{array}{l} \Rightarrow \ Z = 90 \end{array}"),
          EspConstants.esp40,

          // Étape 10 : Identification de l'élément
          transition(transition: "Z = 90 correspond au thorium (Th)"),
        ],
      ),
    );
  }
