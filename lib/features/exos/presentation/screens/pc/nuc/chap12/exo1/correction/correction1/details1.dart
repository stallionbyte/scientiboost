  ...
  Widget build(BuildContext context) {
    return DetailsHandler(
      details: Column(
        ...
        children: [
          // Raisonnement détaillé : Calculer Z et A avec les lois de conservation pour le carbone-14

          // Étape 1 : Équation de départ avec inconnues
          tex(
            math:
                r"\begin{array}{l} _{6}^{14}C \longrightarrow _{Z}^{A}N + _{-1}^{\ \ \ 0}e + _{0}^{0}\bar{\nu} \end{array}",
            scale: 2.0,
          ),
          EspConstants.esp40,
          ...
          tex(math: r"\begin{array}{l} 14 = A + 0 + 0 \end{array}"),
          EspConstants.esp40,

          // Étape 4 : Résolution pour A
          tex(math: r"\begin{array}{l} \Rightarrow \ A = 14 \end{array}"),
          EspConstants.esp40,
          ...
          tex(math: r"\begin{array}{l} \Rightarrow \ Z = 7 \end{array}"),
        ],
      ),
    );
  }
