    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          tex(
            math:
                r"\begin{array}{l} \Delta m = (233,03963 + 1,00866) \\ - (94,91936 + 137,91395 \\ + 2 \times 1,00866) \end{array}",
            scale: 3.0,
          ),
          ...
          tex(
            math: r"\begin{array}{l} Q = 0,18766 \times 931,5 \end{array}",
            scale: 3.0,
          ),
          ...
          BordersWrapper(
            wrapped: result(
              leftTex2SvgMath: r"Q_{fission}",
              valueTex2SvgMath: r"174,8",
