    ...
    return DetailsHandler(
      details: Column(
        ...
        children: [
          ...
          tex(
            math: r"\begin{array}{l} \Delta m = 0,02402\ u \end{array}",
            scale: 3.0,
          ),
          EspConstants.esp40,
          ...
          tex(
            math:
                r"\begin{array}{l} Q = 0,02402 \cdot 931,5\ \frac{MeV}{c^2} \cdot c^2 \end{array}",
            scale: 3.0,
          ),
          EspConstants.esp40,

          tex(
            math: r"\begin{array}{l} Q = 0,02402 \cdot 931,5\ MeV \end{array}",
            scale: 3.0,
          ),
        ],
      ),
