...
class PcMecaChap1Exo6Correction extends ConsumerStatefulWidget {
  const PcMecaChap1Exo6Correction({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _PcMecaChap1Exo6CorrectionState();
}

class _PcMecaChap1Exo6CorrectionState
    extends ConsumerState<PcMecaChap1Exo6Correction> {
  @override
