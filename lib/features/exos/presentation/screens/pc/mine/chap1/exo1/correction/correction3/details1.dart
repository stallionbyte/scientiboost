    ...
    return DetailsHandler(
      details: Column(
        ...
        children: [
          ...
          tex(math: r"\begin{array}{l} ZnSO_4 \cdot 7H_2O \end{array}"),
          EspConstants.esp40,
          ...
          tex(
            math: r"\begin{array}{l} 1 \times Zn : 1 \times M(Zn) \end{array}",
          ),
          EspConstants.esp40,
          ...
          tex(
            math:
                r"\begin{array}{l} 7 \times H_2O : 7 \times (2 \times M(H) \\ + M(O)) \end{array}",
            scale: 3.0,
          ),
          EspConstants.esp40,
          ...
          tex(
            math:
                r"\begin{array}{l} M = M(Zn) \\ + M(S) + 4 \times M(O) \\ + 7 \times [2 \times M(H) + M(O)] \end{array}",
            scale: 4.0,
          ),
        ],
      ),
