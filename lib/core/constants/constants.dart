...
class RoutesNamesConstants {
  ...
  static const String pcNucChap12ExosRoutesExo8 =
  ...
  static const String pcNucChap13ExosRoutesExo2 =
      '/matiere(PC)/nuc/chap(13)/exo(2)';
  static const String pcNucChap13ExosRoutesExo3 =
      '/matiere(PC)/nuc/chap(13)/exo(3)';
  static const String pcNucChap13ExosRoutesExo4 =
      '/matiere(PC)/nuc/chap(13)/exo(4)';
  static const String pcNucChap13ExosRoutesExo5 =
      '/matiere(PC)/nuc/chap(13)/exo(5)';
  static const String pcNucChap13ExosRoutesExo6 =
      '/matiere(PC)/nuc/chap(13)/exo(6)';
  static const String pcNucChap13ExosRoutesExo7 =
      '/matiere(PC)/nuc/chap(13)/exo(7)';
  static const String pcNucChap13ExosRoutesExo8 =
  ...
  static const String pcMineChap1ExosRoutesExo2 =
      '/matiere(PC)/mine/chap(1)/exo(2)';
  static const String pcMineChap1ExosRoutesExo3 =
      '/matiere(PC)/mine/chap(1)/exo(3)';
  static const String pcMineChap1ExosRoutesExo4 =
      '/matiere(PC)/mine/chap(1)/exo(4)';
  static const String pcMineChap1ExosRoutesExo5 =
      '/matiere(PC)/mine/chap(1)/exo(5)';
  static const String pcMineChap1ExosRoutesExo6 =
      '/matiere(PC)/mine/chap(1)/exo(6)';
  static const String pcMineChap1ExosRoutesExo7 =
      '/matiere(PC)/mine/chap(1)/exo(7)';
  static const String pcMineChap1ExosRoutesExo8 =
      '/matiere(PC)/mine/chap(1)/exo(8)';
  static const String pcMineChap1ExosRoutesExo9 =
  ...
  static const String pcMineChap2ExosRoutesExo3 =
      '/matiere(PC)/mine/chap(2)/exo(3)';
  static const String pcMineChap2ExosRoutesExo4 =
      '/matiere(PC)/mine/chap(2)/exo(4)';
