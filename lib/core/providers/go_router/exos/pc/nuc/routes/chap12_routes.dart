...
final pcNucChap12Routes = [
  ...
  GoRoute(
    path: RoutesNamesConstants.pcNucChap12ExosRoutesExo7,
    builder: (context, state) {
      return ExoScreen(
        matiere: matiere,
        chapNum: 12,
  ...
  GoRoute(
    path: RoutesNamesConstants.pcNucChap12ExosRoutesExo8,
    builder: (context, state) {
      return ExoScreen(
        matiere: matiere,
        chapNum: 12,
  ...
  GoRoute(
    path: RoutesNamesConstants.pcNucChap12ExosRoutesExo9,
    builder: (context, state) {
      return ExoScreen(
        matiere: matiere,
        chapNum: 12,
  ...
  GoRoute(
    path: RoutesNamesConstants.pcNucChap12ExosRoutesExo10,
    builder: (context, state) {
      return ExoScreen(
        matiere: matiere,
        chapNum: 12,
