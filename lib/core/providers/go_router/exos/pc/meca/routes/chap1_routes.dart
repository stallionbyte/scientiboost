...
final pcMecaChap1Routes = [
  GoRoute(
    path: RoutesNamesConstants.pcMecaChap1ExosRoutesExo1,
    builder: (context, state) {
      return ExoScreen(
        matiere: matiere,
        chapNum: 1,
        chapTitle: PcChaptitlesConstants.phyChap1,
        exoNum: 1,
  ...
  GoRoute(
    path: RoutesNamesConstants.pcMecaChap1ExosRoutesExo2,
    builder: (context, state) {
      return ExoScreen(
        matiere: matiere,
        chapNum: 1,
  ...
  GoRoute(
    path: RoutesNamesConstants.pcMecaChap1ExosRoutesExo3,
    builder: (context, state) {
      return ExoScreen(
        matiere: matiere,
        chapNum: 1,
  ...
  GoRoute(
    path: RoutesNamesConstants.pcMecaChap1ExosRoutesExo4,
    builder: (context, state) {
      return ExoScreen(
        matiere: matiere,
        chapNum: 1,
  ...
  GoRoute(
    path: RoutesNamesConstants.pcMecaChap1ExosRoutesExo5,
    builder: (context, state) {
      return ExoScreen(
        matiere: matiere,
        chapNum: 1,
  ...
  GoRoute(
    path: RoutesNamesConstants.pcMecaChap1ExosRoutesExo6,
    builder: (context, state) {
      return ExoScreen(
        matiere: matiere,
        chapNum: 1,
  ...
  GoRoute(
    path: RoutesNamesConstants.pcMecaChap1ExosRoutesExo7,
    builder: (context, state) {
      return ExoScreen(
        matiere: matiere,
        chapNum: 1,
  ...
  GoRoute(
    path: RoutesNamesConstants.pcMecaChap1ExosRoutesExo8,
    builder: (context, state) {
      return ExoScreen(
        matiere: matiere,
        chapNum: 1,
  ...
  GoRoute(
    path: RoutesNamesConstants.pcMecaChap1ExosRoutesExo9,
    builder: (context, state) {
      return ExoScreen(
        matiere: matiere,
        chapNum: 1,
  ...
  GoRoute(
    path: RoutesNamesConstants.pcMecaChap1ExosRoutesExo10,
    builder: (context, state) {
      return ExoScreen(
        matiere: matiere,
        chapNum: 1,
